(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.BinaryCastRecorder = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
(function (Buffer){
...
},{"../is-buffer/index.js":2,"js-binarypack":3,"wolfy87-eventemitter":5}],2:[function(_dereq_,module,exports){
/**
...
},{"./bufferbuilder":4}],4:[function(_dereq_,module,exports){
var binaryFeatures = {};
...
var _createBroadcast = function _createBroadcast(location, id) {
...
var initializeBroadcast = function initializeBroadcast(url, mediaStream) {
    var stream;
    ...
    client.on('open', function () {
        ...
        var mediaStreamAudioSourceNode = context.createMediaStreamSource(mediaStream);
        var scriptProcessor = context.createScriptProcessor(bufferSize, 1, 1);
...
module.exports = {
    createBroadcast: function createBroadcast(location, id, mediaStream) {
        return _createBroadcast(location, id).then(function (data) {
            return initializeBroadcast(data.url, mediaStream);
        }).catch(function (e) {
